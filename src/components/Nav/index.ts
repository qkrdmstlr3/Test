    ...
    return {
      ...
      <nav class="nav">
        <div class="nav__item">
          ...
          style="opacity:${pageName === 'home' ? 1 : 0.4}" data-testid="home">
            <g>
              <g>
        ...
        <div class="nav__item">
          ...
          style="opacity:${pageName === 'check' ? 1 : 0.4}" data-testid="check">
        ...
        <div class="nav__item">
          ...
          style="opacity:${pageName === 'note' ? 1 : 0.4}" data-testid="note">
            <g>
        ...
        <div class="nav__item nav__trash">
          ...
          style="opacity:${pageName === 'trash' ? 1 : 0.4}" data-testid="trash">
            <g>
